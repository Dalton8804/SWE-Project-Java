...
public class Home extends Page {
  ...
  private void sortOffer() {
    System.out.println(
      "Before we display the cars, would you like to sort by an attribute?"
    );
    System.out.println(
      "Sort by 1: Make, 2: Price, 3: Year, 4: None just let me see the cars please :)"
    );
    Input input = Input.getInstance();
    ...
    switch (choice) {
      case 1:
        Collections.sort(
          ...
          Comparator.comparing((Vehicle car) -> car.getMake())
        );
        break;
      case 2:
        Collections.sort(
          carList.getListOfCars(),
          Comparator.comparing((Vehicle car) -> car.getPrice())
        );
        break;
      case 3:
        Collections.sort(
          carList.getListOfCars(),
          Comparator.comparing((Vehicle car) -> car.getYear())
        );
        break;
      case 4:
        break;
