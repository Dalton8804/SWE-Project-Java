...
public class AccountPage extends Page {
  ...
  public String render() {
    Main.clearScreen();
    System.out.println(
      "Welcome to your Account Page " + appState.get("username") + "!"
    );
    System.out.println(
      "1: View Listings, 2: Edit Account, 3: Go to home, 4: Logout, 5: Exit App"
    );
  ...
  private void renderEditAccount() {
    ...
    if (choice != 4) nextRoute = "account"; else nextRoute = "login";
  }
  ...
  private void renderViewListings() {
    ...
    switch (choice) {
      case 1:
        System.out.println(
          "Enter VIN(17 digit string including uppercase letters and digits only):"
        );
        ...
        input.nextLine();
        System.out.println(
          "Enter added features(seperate multiple features by comma):"
        );
        ...
        System.out.println(
          "Enter price (if you dont know put 0, we will calculate price for you):"
        );
